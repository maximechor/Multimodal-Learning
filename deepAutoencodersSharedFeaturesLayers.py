...
filepath = "/export/livia/home/vision/mchor/Multimodal Learning/training/2018-06-27-5/"
####################
...
video_branch = Dense(316, input_dim = 316, name ='encoded_video_branch', kernel_initializer=initializers.RandomNormal(seed=None), bias_initializer='zeros', activation='relu')(input_train_Video)
#video_branch = Dropout(0.5)(video_branch)
audio_branch = Dense(102, input_dim = 102, name = 'encoded_audio_branch',kernel_initializer=initializers.RandomNormal(seed=None), bias_initializer='zeros')(input_train_Audio)
...
encoded_shared = Dense(512,kernel_initializer=initializers.RandomNormal(seed=None) , bias_initializer='zeros',activation='relu', name ='encoder_512')(sharedFeature)
#encoded_shared = Dropout(0.5)(encoded_shared)
encoded_shared = Dense(256,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros', activation='relu', name ='encoder_256', )(encoded_shared)
#encoded_shared = Dropout(0.5)(encoded_shared)
encoded_shared = Dense(128,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros', activation='relu', name ='encoder_128')(encoded_shared)
#encoded_shared = Dropout(0.5)(encoded_shared)
#encoded_shared = Dense(64, activation='relu', name ='encoder_64')(encoded_shared)

####Encoded#########
encoded  = Dense(128,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros' ,activation='sigmoid', name ='autoencoder_128')(encoded_shared)

################## Build Decoder  ###########################
#decoded_shared = Dense(64, activation='relu', name ='decoder_64')(encoded)
decoded_shared = Dense(128,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation='relu', name ='decoder_128')(encoded)
#decoded_shared = Dropout(0.5)(decoded_shared)
decoded_shared = Dense(256,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation='relu', name ='decoder_256')(decoded_shared)
#decoded_shared = Dropout(0.5)(decoded_shared)
decoded_shared = Dense(512,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation= 'relu', name ='decoder_512')(decoded_shared)
#decoded_shared = Dropout(0.5)(decoded_shared)

############################### Separated Layers ##########################
decoded_video_branch = Dense(316,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation='relu', name ='decoded_video_branch')(decoded_shared)
#decoded_video_branch = Dropout(0.5)(decoded_video_branch)
decoded_audio_branch = Dense(102,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation='relu', name ='decoded_audio_branch')(decoded_shared)
#decoded_audio_branch = Dropout(0.5)(decoded_audio_branch)

############################### Output Layers ##########################
decoded_video_output = Dense(316,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation='relu', name ='output_video')(decoded_video_branch)
#decoded_video_output = Dropout(0.5, name = 'output_video_dropout')(decoded_video_output)
decoded_audio_output = Dense(102,kernel_initializer=initializers.RandomNormal(seed=None),bias_initializer='zeros',activation='relu', name ='output_audio')(decoded_audio_branch)
#decoded_audio_output = Dropout(0.5, name = 'output_audio_dropout')(decoded_audio_output)
...
'''decoder_audio = autoencoder.layers[-10](encoded_input)
...
'''decoder_video = autoencoder.layers[-10](encoded_input)
...
plot_model(autoencoder,to_file=filepath + 'modelautoencoder_ShF_T4.png', show_shapes =True, show_layer_names=True )
...
autoencoder.save(filepath + 'autoencoder_ShF_T4.h5') 
...
plt.savefig(filepath + 'modelaccuracyVideo_ShF_T4.png')
...
plt.savefig(filepath + 'modelaccuracyAudio_ShF_T4.png')
...
plt.savefig(filepath + 'modellossVideo_ShF_T4.png')
...
plt.savefig(filepath + 'modellossAudio_ShF_T4.png')
...
plt.savefig(filepath + 'modelloss_ShF_T4.png')
...
np.savetxt(filepath + 'encoded_ShF_train_1.csv', encoded_feature_train, delimiter=",")

#np.savetxt("/home/AN84020/training/featuresLearning/encoded_ShF_dev_1.csv", encoded_feature_dev, delimiter=",")
np.savetxt(filepath + 'encoded_ShF_dev_1.csv', encoded_feature_dev, delimiter=",")
