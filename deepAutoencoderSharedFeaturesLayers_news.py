...
filepath = "/export/livia/home/vision/mchor/Multimodal Learning/training/2018-07-05-0/"
...
ecg_branch = Dense(54, input_dim = 54, name='encoded_ecg_branch', kernel_initializer = initializers.glorot_uniform(seed=None), bias_initializer ='zeros')(input_train_ECG)
#ecg_branch = Dropout(0.5)(ecg_branch)
...
#eda_branch = Dropout(0.5)(eda_branch)
...
#video_Appearance_branch = Dropout(0.5)(video_Appearance_branch)
...
encoded_shared = Dense(550,kernel_initializer=initializers.glorot_uniform(seed=None) , bias_initializer='zeros',activation='relu', name ='encoder_550')(sharedFeature)
#encoded_shared= Dropout(0.5)(encoded_shared)

encoded_shared = Dense(450,kernel_initializer=initializers.glorot_uniform(seed=None),bias_initializer='zeros', activation='relu', name ='encoder_450')(encoded_shared)
#encoded_shared = Dropout(0.5)(encoded_shared)

encoded_shared = Dense(350,kernel_initializer=initializers.glorot_uniform(seed=None),bias_initializer='zeros', activation='relu', name ='encoder_350')(encoded_shared)
#encoded_shared = Dropout(0.5)(encoded_shared)
...
####Encoded#########
encoded  = Dense(200,kernel_initializer=initializers.glorot_uniform(seed=None),bias_initializer='zeros' ,activation='sigmoid', name ='autoencoder_200')(encoded_shared)
#encoded = Dropout(0.5)(encoded)

################## Build Decoder  ###########################
#decoded_shared = Dense(64, activation='relu', name ='decoder_64')(encoded)
decoded_shared = Dense(350,kernel_initializer=initializers.glorot_uniform(seed=None),bias_initializer='zeros',activation='relu', name ='decoder_350')(encoded)
#decoded_shared = Dropout(0.5)(decoded_shared)

decoded_shared = Dense(450,kernel_initializer=initializers.glorot_uniform(seed=None),bias_initializer='zeros',activation='relu', name ='decoder_450')(decoded_shared)
#decoded_shared = Dropout(0.5)(decoded_shared)

decoded_shared = Dense(550,kernel_initializer=initializers.glorot_uniform(seed=None),bias_initializer='zeros',activation= 'relu', name ='decoder_550')(decoded_shared)
#decoded_shared = Dropout(0.5)(decoded_shared)
...
decoder4.summary()
decoder5.summary()
plot_model(autoencoder,to_file=filepath + 'modelautoencoder_ShF_T100.png', show_shapes =True, show_layer_names=True )
...
autoencoder.save(filepath + 'autoencoder_ShF_T100.h5') 
...
plt.savefig(filepath + 'modelaccuracyVideo_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modelaccuracyAudio_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modelaccuracyECG_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modelaccuracyEDA_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modelaccuracyVideoAppearance_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modellossVideo_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modellossAudio_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modellossECG_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modellossEDA_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modellossVideoAppearance_ShF_T100.jpeg')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(filepath + 'modelloss_ShF_T100.jpeg')
...
np.savetxt(filepath + 'encoded_ShF_train_100.csv', encoded_feature_train, delimiter=",")

np.savetxt(filepath + 'encoded_ShF_dev_100.csv', encoded_feature_dev, delimiter=",")
