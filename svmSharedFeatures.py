...
filepath = "/export/livia/home/vision/mchor/Multimodal Learning/training/2018-07-04-0/"

####################### Load Shared Feature Files####################
#encoded_train = pd.read_csv('encoded_train1.csv', header = None)
encoded_train = pd.read_csv(filepath + 'encoded_ShF_train_100.csv',header =None)
print("encoded_train:", encoded_train.shape)

#encoded_dev = pd.read_csv('encoded_valid1.csv', header = None)
encoded_dev = pd.read_csv(filepath + 'encoded_ShF_dev_100.csv', header = None)
...
#############For Arousal###########################
train_arousal = arff.load(open('/export/livia/home/vision/mchor/Multimodal Learning/ratings_gold_standard/arousal/train_all.arff'))
...
dev_arousal = arff.load(open('/export/livia/home/vision/mchor/Multimodal Learning/ratings_gold_standard/arousal/dev_all.arff'))
...
###################################For Valence################################
train_valence = arff.load(open('/export/livia/home/vision/mchor/Multimodal Learning/ratings_gold_standard/valence/train_all.arff'))
...
dev_valence = arff.load(open('/export/livia/home/vision/mchor/Multimodal Learning/ratings_gold_standard/valence/dev_all.arff'))
...
df.to_csv(filepath + 'valCCC_1_valence.csv', sep=',', index=False)
df = pd.DataFrame(data={'Val CCC':[val_ccc_arousal], 'score':[score_arousal]})
df.to_csv(filepath + 'valCCC_1_arousal.csv', sep=',', index=False)
