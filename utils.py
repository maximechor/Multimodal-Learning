...
path = '/export/livia/Database/Odilon/odilon/Odilon/concatenated/'
...
def LoadRecolaVideo(preprocessingData):
    ...
    x_train_video = arff.load(
        open(path + 'features_video_geometric_features/train_123456789.arff', 'r'))
    x_test_video = arff.load(
        open(path + 'features_video_geometric_features/test_123456789.arff', 'r'))
    x_valid_video = arff.load(
        open(path + 'features_video_geometric_features/dev_123456789.arff', 'r'))
...
def LoadRecolaAudio(preprocessingData):
    ...
    x_train_audio = arff.load(open(path + 'features_audio/train_123456789.arff', 'r'))
    x_test_audio = arff.load(open(path + 'features_audio/test_123456789.arff', 'r'))
    x_valid_audio = arff.load(open(path + 'features_audio/dev_123456789.arff', 'r'))
...
def LoadRecolaECG(preprocessingData):
    x_train_ecg = arff.load(open(path + 'features_ecg/train_123456789.arff', 'r'))
    x_test_ecg = arff.load(open(path + 'features_ecg/test_123456789.arff', 'r'))
    x_valid_ecg = arff.load(open(path + 'features_ecg/dev_123456789.arff', 'r'))
...
def LoadRecolaEDA(preprocessingData):
    ...
    x_train_eda = arff.load(
        open(path + 'features_eda/train_123456789.arff', 'r'))
    x_test_eda = arff.load(
        open(path + 'features_eda/test_123456789.arff', 'r'))
    x_valid_eda = arff.load(
        open(path + 'features_eda/dev_123456789.arff', 'r'))
...
def LoadRecolaVideoAppearance(preprocessingData):
    ...
    x_train_video_appea = arff.load(
        open(path + 'features_video_appearance/train_123456789.arff', 'r'))
    x_test_video_appea = arff.load(
        open(path + 'features_video_appearance/test_123456789.arff', 'r'))
    x_valid_video_appea = arff.load(
        open(path + 'features_video_appearance/dev_123456789.arff', 'r'))
